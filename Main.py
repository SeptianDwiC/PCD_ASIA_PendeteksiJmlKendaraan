...
while(True):
    ...
    for (i,c) in enumerate(counterShape):
        ...
        cv2.putText(frame1,"KENDARAAN NO : "+str(counter),(x,y-20),cv2.FONT_HERSHEY_TRIPLEX,1,(255,244,0),2)
    ...
    cv2.putText(frame1,"JUMLAH KENDARAAN : "+str(counter),(450,70),cv2.FONT_ITALIC,2,(0,0,255),5)
